        ...
        <div className="about-section4">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <div style={{ flex: '1', fontSize: '25px', marginLeft: '40px', marginRight: '40px' }}>
              ...
              <Link to="/stage" className="fbutton">
                <i></i><i></i>
                <span>Stage Module</span>
                </Link>

                <Link to="/arts" className="fbutton1">
                <i></i><i></i>
                <span>Arts Module</span>
                </Link>

                <Link to="/gaming" className="fbutton2">
                <i></i><i></i>
                <span>Gaming Module</span>
                </Link>

                <Link to="/auditorium" className="fbutton3">
                <i></i><i></i>
                <span>Auditorium Module</span>
                </Link>

                <Link to="/volleyball" className="fbutton4">
                <i></i><i></i>
