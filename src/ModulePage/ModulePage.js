        ...
        <div className="about-section4">
          ...
          >
            ...
            >
              ...
              entertainment. Discover diverse modules designed for every
              interest, from expert-led sessions to hands-on workshops. Brace
              yourself for gaming tournaments, awesome activities, and surprises
              that promise an unforgettable experience. Join us in shaping the
              future - it's more than an event; it's a celebration of learning
              and entertainment.
              <br />
              <span style={{ fontSize: "4rem", lineHeight: 1.5 }}>
                ON SCNZ GUYZ!!!!!
              </span>
              <br />
